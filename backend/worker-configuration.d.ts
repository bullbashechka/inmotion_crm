/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file=/dev/null` (hash: 2e6f9bbce8a2e8d6e747ff354591ecf4)
...
interface __BaseEnv_Env {
	...
	AUTH_SOURCE_RATE_LIMITER: RateLimit;
	APP_ENV: "local";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_ENV" | "APP_BUILD_VERSION" | "SUPPORTED_CLIENT_VERSIONS" | "CORS_ORIGINS">> {}
}
