...
INSERT INTO crm.role_grants (id, role_revision_id, permission_code, scope) VALUES
  ...
  ('00000000-0000-7000-8000-000000000609', '00000000-0000-7000-8000-000000000403', 'medical.read.assigned', '{"records":"assigned"}'),
  ('00000000-0000-7000-8000-000000000610', '00000000-0000-7000-8000-000000000403', 'medical.write.assigned', '{"records":"assigned"}'),
  ('00000000-0000-7000-8000-000000000611', '00000000-0000-7000-8000-000000000404', 'medical.read.assigned', '{"records":"assigned"}'),
  ('00000000-0000-7000-8000-000000000612', '00000000-0000-7000-8000-000000000404', 'medical.write.assigned', '{"records":"assigned"}'),
  ('00000000-0000-7000-8000-000000000613', '00000000-0000-7000-8000-000000000405', 'medical.read.assigned', '{"records":"assigned"}'),
  ('00000000-0000-7000-8000-000000000614', '00000000-0000-7000-8000-000000000405', 'medical.write.assigned', '{"records":"assigned"}'),
  ('00000000-0000-7000-8000-000000000615', '00000000-0000-7000-8000-000000000406', 'medical.read.assigned', '{"records":"assigned"}'),
  ('00000000-0000-7000-8000-000000000616', '00000000-0000-7000-8000-000000000406', 'medical.write.assigned', '{"records":"assigned"}')
ON CONFLICT (role_revision_id, permission_code) DO NOTHING;
