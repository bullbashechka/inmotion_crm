...
Этот проект не является open source. Исходный код опубликован только для
ознакомления. Без предварительного письменного разрешения правообладателя
запрещены использование, запуск, копирование, изменение, создание производных
работ, развёртывание, распространение и любое коммерческое применение. См. [LICENSE](LICENSE).

Исторические версии и фрагменты, уже опубликованные под Apache License 2.0, сохраняют
ранее выданные Apache-права. Новые условия действуют для оригинальных материалов,
впервые опубликованных правообладателем с 15 августа 2026 года.
